...
import 에너지 from '../img/에너지.png'
import 소재 from '../img/소재.png'
import 산업재 from '../img/산업재.png'
import 경기소비재 from '../img/경기소비재.png'
import 필수소비재 from '../img/필수소비재.png'
...
//                         <div class="flex-col interest-box"  className={`interest-box ${isClicked ? 'clicked' : ''}`}>
//                             <img class="interest-img" src={bottel}></img>
